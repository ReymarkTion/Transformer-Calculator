...
public class core2_controller implements Initializable {
	...
	@FXML TextField air_gap_L_field;
	@FXML TextField air_gap_R_field;
	@FXML TextField air_gap_inc_field;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		fig_1.setImage(new Image("/figures/figure 2.png"));
	...
	private void buttonActions() {
		...
		calc_button.addEventFilter(MouseEvent.MOUSE_CLICKED, e -> {
			if(addData()) {
				...
				try { layout = Main.getCalculation_2_Layout();
	...
	private boolean addData() {
		...
		try {
			...
			Main.getCore_data().insert(convert(l_7.getText()), "l7");
			Main.getCore_data().insert(convert(l_8.getText()), "l8");
			
			Main.getCore_data().insert(convert(air_gap_L_field.getText()), "air gap left");
			Main.getCore_data().insert(convert(air_gap_R_field.getText()), "air gap rigth");
			
			float percent = Float.parseFloat(air_gap_inc_field.getText()) / 100;
			Main.getCore_data().insert(percent, "air gap inc");
